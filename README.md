...
- **0.5 — plan & people**: partial resource allocation with a pre-commit over-allocation warning, the hybrid human/AI scheduling first cut (AI agents as schedulable resources, on the same allocation model), timesheets, baselines, installable PWA, first-run onboarding, CSV/Excel and one-time Jira migration imports
