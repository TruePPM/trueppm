...
2. **Sign in as a team member.** Open `http://localhost:5173` and sign in as **`atlas-tom`** — Tom Becker, Engineer, a **Team Member** on Platform Core and Migration Tooling, carrying work in the active sprint.
