...
<CardGrid>
  ...
  <Card title="Hybrid" icon="random">
    The same task is both a WBS node and a sprint story. Sprint velocity feeds the CPM forecast — non-destructive suggestions today; automatic reforecast on sprint close lands in 0.3 (not yet shipped). Zero reconciliation meetings. [Read the full story →](/the-story/)
  </Card>
</CardGrid>
...
|---------|-------------|----------------------|-------|
| **Project Managers** | Waterfall / Hybrid | CPM schedules, Monte Carlo confidence intervals, critical path, velocity-suggested Gantt durations (automatic reforecast lands in 0.3 — not yet shipped) | [Guide →](/guides/project-managers/) |
