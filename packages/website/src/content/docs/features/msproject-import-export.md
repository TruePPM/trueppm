...
:::note[Import-into-existing requires Admin]
The import action is enforced server-side: you must have the **Admin** (Project
Manager) role on the project. Members below Admin do not see the import
