...
- **No fill-down.** Multi-row select and duplicate exist, and 0.4 added [paste-many from a spreadsheet](#paste-rows-from-a-spreadsheet); a fill-down / fill-series gesture for extending a value down a column does not exist yet.
