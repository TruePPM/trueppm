  ...
  return (
    <div className="flex gap-2 px-4 py-2.5 border-t border-neutral-border bg-neutral-surface-raised">
      ...
      <button
        type="button"
        onClick={onEdit}
        className="h-8 md:h-8 min-h-11 md:min-h-0 px-3.5 rounded-control bg-brand-primary text-neutral-text-inverse text-[13px] font-medium border-none hover:bg-brand-primary-dark focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-1 focus-visible:ring-offset-brand-primary focus-visible:outline-none"
      >
        Edit
      </button>
    </div>
