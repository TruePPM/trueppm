...
interface Props {
  ...
  /**
   * Board cadence (ADR-0161, issue 410). `continuous` runs continuous-flow Kanban, which
...
export function SprintPanel({ projectId, methodology, boardCadence }: Props) {
  ...
  // Hide for WATERFALL projects, continuous-flow Kanban boards (ADR-0161, issue 410),
