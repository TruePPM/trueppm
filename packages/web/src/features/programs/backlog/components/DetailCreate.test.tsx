...
describe('DetailCreate', () => {
  it('blocks submit and shows an inline error when the title is empty', () => {
    ...
    render(<DetailCreate tagSuggestions={[]} estimationScale="fibonacci" onCancel={vi.fn()} onCreate={onCreate} />);
  ...
  it('Cancel with no edits closes immediately, without the unsaved guard (#1996)', () => {
    ...
    render(<DetailCreate tagSuggestions={[]} estimationScale="fibonacci" onCancel={onCancel} onCreate={vi.fn()} />);
