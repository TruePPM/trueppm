...
//
// Every task carries `plannedStart` set to its `start` — the fixture represents
// a project the PM has fully committed to. Without `plannedStart` the UI gates
// for #332 (suppress CP/float and Gantt bars on uncommitted tasks) would treat
// every fixture task as backlog. Tests that exercise the uncommitted path
// override `plannedStart: null` explicitly.
