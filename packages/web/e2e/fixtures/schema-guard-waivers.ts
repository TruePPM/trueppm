 ...
 * #3440 corrected four field families, #3651 corrected 11 more (nullability),
 * and these 91 operations are what is left.
 *
 * ## Shape
 *
 *   'GET /api/v1/thing/': {
 ...
 *   chasing. `'*'` costs enforcement on the other properties of these 91
