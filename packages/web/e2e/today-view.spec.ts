...
async function base(page: Page, opts: { overview?: typeof ATRISK_OVERVIEW; tasks?: unknown[] } = {}) {
...
test.describe('Unified Today view (ADR-0180)', () => {
  test('golden path — renders the schedule strip + active-sprint rollup above the board', async ({
    ...
    // An ACTIVE sprint (overrides the fixtures' empty default — registered later).
