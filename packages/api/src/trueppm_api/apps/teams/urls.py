...
0.3 slice surface only: list a project's teams, list a team's roster, and PATCH
a member's role/facets. Retrieving one team by id, create/delete of teams and
members, the activity feed, and the TeamInternalsOptIn toggle land with #599.
"""
