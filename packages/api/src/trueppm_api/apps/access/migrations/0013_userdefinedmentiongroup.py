...
class Migration(migrations.Migration):
    dependencies = [
        ("access", "0001_squashed_0012_programmembership_role_title"),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, related_name="mention_groups", to=settings.AUTH_USER_MODEL
                    ),
                ),
                (
                    "muted_by",
                    models.ManyToManyField(
                        blank=True, related_name="muted_mention_groups", to=settings.AUTH_USER_MODEL
                    ),
                ),
                (
                    "project",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["project", "server_version"], name="udmg_proj_serverver_idx"
                    )
                ],
                "constraints": [
