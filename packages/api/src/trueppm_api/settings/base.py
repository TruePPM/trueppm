...
CELERY_BEAT_SCHEDULE = {
    ...
    # blip / worker death (ADR-0152, #388). The durability backstop for capture.
    ...
    # snapshots — all <90 d, weekly to 1 y, monthly forever (ADR-0152, #388).
...
# Tiered retention curve for project-grain forecast snapshots (ADR-0152, #388).
