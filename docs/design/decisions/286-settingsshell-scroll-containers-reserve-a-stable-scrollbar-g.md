# Rule 286 — SettingsShell scroll containers reserve a stable scrollbar gutter

> **Decision record.** Moved out of `packages/web/CLAUDE.md` by #2433 (ADR-0653): precedent bound to one surface, not a general invariant. It is still binding for the surface it governs.
>
> Original section: *Settings Shell Save Contract (Issue #536)*
>
> **Renumbered from 122.** The source file used `122.` twice — this rule and the disabled-placeholder recipe. Every `rule 122` citation in the codebase means the latter, so that one keeps the number and this one takes the next free one.
