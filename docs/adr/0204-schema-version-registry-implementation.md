# ADR-0204: Forward-Migration Registry Implementation for User-Saved JSON State
...
> this branch landed, so this record takes the next genuinely-free number. 0199/0200 were taken on main, 0201 collided with a parallel branch (#374), and 0202 with #1113 (trash/restore), so this record uses 0204.
